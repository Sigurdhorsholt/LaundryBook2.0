  ...
  return (
    <div className="p-4 p-lg-5">
      ...
      <div
        ...
        style={{ border: '2px dashed #e8ecf0', minHeight: 240, maxWidth: 760 }}
      >
        <p className="fw-semibold mb-1" style={{ color: '#0d1b2a' }}>Ingen lokaler endnu</p>
        <p style={{ color: '#5a6a7a', fontSize: '0.9rem', maxWidth: 360 }}>
          Denne funktion er under udvikling. Lokaler og maskiner kan tilføjes når API'et er klar.
        </p>
      </div>
    </div>
  )
