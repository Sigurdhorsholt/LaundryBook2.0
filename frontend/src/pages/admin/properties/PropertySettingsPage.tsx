  ...
  return (
    <div className="p-4 p-lg-5">
      ...
      <div
        ...
        style={{ border: '2px dashed #e8ecf0', minHeight: 240, maxWidth: 800 }}
      >
        <p className="fw-semibold mb-1" style={{ color: '#0d1b2a' }}>Indstillinger ikke tilgængelige endnu</p>
        <p style={{ color: '#5a6a7a', fontSize: '0.9rem', maxWidth: 400 }}>
          Bookingtype, afbestillingsvindue og maks. bookinger pr. beboer konfigureres her når API'et er klar.
        </p>
      </div>
    </div>
  )
