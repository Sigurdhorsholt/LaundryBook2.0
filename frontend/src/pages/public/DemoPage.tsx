...
const TIP_KEYS = ['book', 'switchDay', 'cancel', 'dots'] as const
                ...
                {TIP_KEYS.map((k, i) => (
                  <div key={k} className="col-12 col-sm-6">
                    <div className="d-flex align-items-start gap-3">
                      ...
                      <span style={{ color: colors.textPrimary, fontSize: '0.95rem', lineHeight: 1.55 }}>{t(`public.demo.tips.${k}`)}</span>
                    </div>
                  </div>
                ))}
              </div>
