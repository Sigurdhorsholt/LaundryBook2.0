...
internal static class AdminPasswordResetEmailTemplate
{
    internal static string Html(string resetLink, string propertyName, string adminName, string landingPageUrl) => $$"""
        <!DOCTYPE html>
        <html lang="da">
        <head>
          <meta charset="utf-8">
                ...
                <table class="main-table" width="600" cellpadding="0" cellspacing="0" role="presentation" style="margin:0 auto;background-color:#ffffff;border:1px solid #b8ddc9;border-radius:12px;overflow:hidden;box-shadow:0 4px 12px rgba(61,122,92,0.05);">
                  ...
                  <tr>
                    <td class="content-padding" style="padding:40px 48px 32px;">
                      <h2 style="margin:0 0 12px;font-size:22px;font-weight:700;color:#1a2e24;">Din adgangskode er nulstillet</h2>
                      <p style="margin:0 0 28px;font-size:15px;color:#1a2e24;line-height:1.65;">
                        <strong>{{adminName}}</strong> har nulstillet adgangskoden til din <strong>LaundryBook</strong>-konto i {{propertyName}}.
                        ...
                        <tr>
                          <td style="padding:16px 20px;">
                            <p style="margin:0;font-size:13px;color:#92400e;line-height:1.5;">
                              ...
                              Genkender du ikke dette, s&aring; kontakt din administrator.
                            </p>
                          </td>
                        </tr>
                      </table>
                        ...
                        <tr>
                          <td align="center" style="background-color:#3d7a5c;border-radius:8px;">
                            <a href="{{resetLink}}" style="display:inline-block;padding:16px 36px;color:#ffffff;text-decoration:none;font-size:16px;font-weight:700;letter-spacing:0.2px;">
                              V&aelig;lg ny adgangskode &rarr;
                            </a>
                          </td>
                        </tr>
                      </table>
    ...
    internal static string Text(string resetLink, string propertyName, string adminName, string landingPageUrl) => $"""
        Din adgangskode er nulstillet
        ========================================

        {adminName} har nulstillet adgangskoden til din LaundryBook-konto i {propertyName}.

        Klik på linket nedenfor for at vælge en ny adgangskode:
        {resetLink}

        Linket er gyldigt i 1 time.
        Genkender du ikke dette, så kontakt din administrator.
